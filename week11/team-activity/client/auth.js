...
export default class Auth {
    ...
    async login(callback) {
        ...
        try {
            ...
            const token = await makeRequest('login', 'POST', postData);
    ...
    async getCurrentUser(email) {
        try {
            ...
            let users = await makeRequest('users', 'GET', null, this.jwtToken)
    ...
    //         let posts = await makeRequest('posts', 'GET', null, token)
